...
<footer class="df-footer" id="contact">
	<div class="df-container">
		<div class="df-footer-grid">
			...
			<div><h3>Contact</h3><p><?php echo esc_html( driveflex_option( 'driveflex_phone', '+254 700 000 000' ) ); ?></p><p><?php echo esc_html( driveflex_option( 'driveflex_email', 'bookings@example.com' ) ); ?></p><p><?php echo esc_html( driveflex_option( 'driveflex_location', 'Nairobi, Kenya' ) ); ?></p></div>
