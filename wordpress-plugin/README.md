...
This folder contains the installable DriveFlex plugin and its release ZIP.
...
2. Upload `driveflex-booking-1.0.0.zip`, install and activate it.
3. Open **DriveFlex Vehicles > Settings** and set the booking email and WhatsApp number.
4. Select **Import or update starter fleet**.
