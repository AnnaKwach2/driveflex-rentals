<?php
/**
 * Plugin Name: DriveFlex Fleet & Booking
 * Description: Fleet management, rental estimates, availability, and booking requests for DriveFlex Rentals.
 * Version: 1.0.0
 * Author: DesignPhox
...
define( 'DRIVEFLEX_VERSION', '1.0.0' );
